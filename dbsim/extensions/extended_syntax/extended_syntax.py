...
class ExtendedSyntax(object):
    ...
    def addExtendedDataTypes(cls) -> None:
        ...
        if hasattr(cls, "_extended_data_types_"):
            field.addDataTypes(
                {datatype: datatype for datatype in cls._extended_data_types_.values()}
            )
        ...
        if hasattr(cls, "_extended_data_types_converter_"):
            AdapterFactory.addDataTypeConverter(
                cls, cls._extended_data_types_converter_
            )

    @classmethod
    def removeExtendedDataTypes(cls) -> None:
        if hasattr(cls, "_extended_data_types_"):
            field.removeDataTypes(
                {datatype: datatype for datatype in cls._extended_data_types_.values()}
            )

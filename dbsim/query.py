...
class Query(object):
    ...
    def __init__(
        self, dataset, operations: Expr, resolve_op_schema: bool = True, optimizer=None
    ):
        ...
        if resolve_op_schema:
            ...
            if not operations.isResolved():
                ...
                raise PlannerInternalError(
                    "The input expression tree ('operations') must be resolved when 'resolve_op_schema' is False."
                )

...
demo_dataset_users = DataFrame(
    [
        (1234, "Tom", date(2009, 1, 17), np.array([1, 2, 3, 4])),
        (4567, "Sally", date(2010, 2, 24), np.array([4, 5, 6, 7])),
        (8901, "Mark", date(2010, 3, 1), np.array([8, 9, 0, 1])),
        (9999, "Tony", date(2010, 3, 1), np.array([9, 9, 9, 9])),
    ],
...
demo_dataset_movies_animation = DataFrame(
    [
        (1234, "Toy Story", 1995, np.array([1, 2, 3, 4])),
        (4567, "Balto", 1995, np.array([4, 5, 6, 7])),
        (6789, "Swan Princess", 1994, np.array([6, 7, 8, 9])),
        (1011, "Aladdin", 1992, np.array([1, 0, 1, 1])),
        (1235, "Snow White and the Seven Dwarfs", 1937, np.array([1, 2, 3, 5])),
        (1236, "Beauty and the Beast", 1991, np.array([1, 2, 3, 6])),
    ],
...
demo_dataset_movies_musical = DataFrame(
    [
        ...
        (1236, "Beauty and the Beast", 1991, np.array([1, 2, 3, 6])),
        (1011, "Aladdin", 1992, np.array([1, 0, 1, 1])),
        (9800, "Singin' in the Rain", 1952, np.array([9, 8, 0, 0])),
        (9858, "American in Paris", 1951, np.array([9, 8, 5, 8])),
    ],
    columns=["mid", "title", "year", "embedding"],
)
